...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("Error submitting message. Try again later.");
  ...
  return (
    <div className="contact-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p>
            ...
            volunteer, or need our services, we're here to help.
          </p>
        </div>
      </section>
      ...
      <section className="methods-section">
        ...
        <p>
          Choose the method that works best for you. We're available and ready
          to assist.
        </p>
      ...
      <section className="org-section">
        ...
        <div className="org-grid">
          <div className="org-card">
            ...
            <p>
              <strong>Organization:</strong> Aadnya Foundation Trust
            </p>
            <p>
              <strong>Established:</strong> 2023
            </p>
            <p>
              <strong>Registration:</strong> Est-2024
            </p>
            <p>
              <strong>PAN:</strong> AAKTA7415P
            </p>
            <p>
              <strong>Public Trust:</strong> E-001367S(THN)
            </p>
            <p>
              <strong>NITI AYOG NGO ID:</strong> MH/2024/0416858
            </p>
          </div>
          <div className="org-card">
            <h3>Banking Details</h3>
            <p>
              <strong>Bank:</strong> HDFC Bank Badlapur(West)
            </p>
            <p>
              <strong>Account No:</strong> 50200097236027
            </p>
            <p>
              <strong>IFSC Code:</strong> HDFC0008382
            </p>
            <p>
              <strong>UPI ID:</strong> aadnyafoundationtrust@ybl
            </p>
            <p>
              <strong>Website:</strong> www.aadnya.org
            </p>
          </div>
        </div>
        ...
        <p className="org-note">
          Together, we can make Maharashtra a more compassionate place for
          everyone.
        </p>
      </section>
